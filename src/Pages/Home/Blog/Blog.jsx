        ...
        <div className="my-16">
            ...
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-10 my-10">
                    <Zoom triggerOnce fraction={1} delay={100} duration={1000}>
                        <div className="card card-compact test-start  w-full rounded-lg bg-white  dark:bg-slate-800 shadow-xl">
                            ...
                            <div className=" py-4 px-4 rounded-b-lg  dark:text-gray-300 text-gray-800">
                                ...
                                <p className="text-start mt-3">
                                    In the realm of photography, light is the quintessential
                                    ingredient that can transform an ordinary image into an
                        ...
                        <div className="card card-compact test-start  w-full rounded-lg bg-white  dark:bg-slate-800 shadow-xl">
                            ...
                            <div className=" py-4 px-4 rounded-b-lg  dark:text-gray-300 text-gray-800">
                                ...
                                <p className="text-start mt-3">
                                    ...
                                    photography, as it allows you to select the most suitable
                                    approach for your desired outcome
                                    <span className="text-green hover:underline cursor-pointer">
                                        ...read more
                                    </span>
                                </p>
                    ...
                    <Zoom triggerOnce fraction={1} delay={100} duration={1000}>
                        <div className="card card-compact test-start  w-full rounded-lg bg-white  dark:bg-slate-800 shadow-xl">
                            ...
                            <div className=" py-4 px-4 rounded-b-lg  dark:text-gray-300 text-gray-800">
                                ...
                                <p className="text-start mt-3">
                                    tart by observing how the light changes throughout the day, from
                                    the soft, warm tones of sunrise and sunset to the harsh midday
                                    sunlight.
                                    <span className="text-green hover:underline cursor-pointer">
                                        ...read more
                                    </span>
